<footer id="footer"><!--Footer-->
		...
		<div class="footer-widget">
			<div class="container">
				<div class="row">
					<div class="col-sm-3">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">Cung Cấp Sản Phẩm Quần Áo Mới Nhất</a></li>
					...
					<div class="col-sm-3">
						<div class="single-widget">
							<h2>Địa chỉ và Liện hệ</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">+ ngõ 2 Tân Triều, Hà Nội</a></li>
								<li><a href="#">+ 84377596359</a></li>
								<li><a href="#">+ thuhabbctll@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2023 Evil-Store Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/thuhabbctll/">PhamThuHa</a></span></p>
				</div>
			</div>
		</div>	
	</footer><!--/Footer-->
